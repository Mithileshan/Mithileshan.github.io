...
export default function ProjectCard({ project }: { project: Project }) {
  return (
    <motion.div
      ...
      className="group bg-surface border border-white/8 rounded-2xl overflow-hidden flex flex-col h-full hover:border-accent/25 transition-colors duration-300"
    >
      {/* Image / placeholder */}
      <div className="w-full h-44 bg-[#0d1724] border-b border-white/5 overflow-hidden relative flex items-center justify-center">
        ...
        />
        <span className="text-white/[0.06] font-mono text-6xl font-bold select-none tracking-tighter z-0">
